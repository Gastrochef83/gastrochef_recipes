      ...
      <div className="gc-a4">
        <div className="gc-a4-card">
          ...
          <section className="gc-a4-kpis">
            ...
            <div className="gc-a4-kpi">
              <div className="gc-a4-kpi-k">Lines</div>
              <div className="gc-a4-kpi-v">{lines.filter((l) => l.line_type !== 'group').length}</div>
            </div>
          </section>
                    ...
                    <tr key={l.id}>
                      <td className="gc-a4-item">
                        ...
                        <div className="gc-a4-item-sub">
                          {l.line_type === 'subrecipe' ? 'Subrecipe' : 'Ingredient'} • {pct.toFixed(1)}% of cost
                        </div>
                      </td>
                      <td className="gc-a4-num">{fmtQty(c.net)} {safeUnit(l.unit)}</td>
                      <td className="gc-a4-num">{fmtQty(c.gross)} {safeUnit(l.unit)}</td>
