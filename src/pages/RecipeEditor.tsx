  ...
  const NeoStyles = (
    <style>{`
      ...
      .gc-recipe-pro {
        ...
        --hover-shadow: 0 24px 48px -12px rgba(20,184,166,0.18);
        position: relative;
        max-width: 100%;
        overflow-x: hidden;
      }
      ...
      .gc-recipe-pro-titleIcon {
        ...
        box-shadow: 0 8px 16px -4px rgba(20,184,166,0.15);
      ...
      .gc-recipe-pro-titleIcon:hover {
        ...
        box-shadow: 0 12px 24px -6px rgba(20,184,166,0.25);
      }
      ...
      .gc-recipe-pro-statusDot {
        ...
        height: 10px;
        border-radius: 999px;
        background: linear-gradient(135deg, #4CAF50, #14b8a6);
      ...
      .gc-recipe-pro .gc-btn-soft:hover {
        background: white;
        border-color: var(--primary);
        box-shadow: 0 8px 16px -6px rgba(20,184,166,0.2);
      ...
      .gc-recipe-pro .gc-btn-soft.is-active {
        ...
        font-weight: 700;
        box-shadow: inset 0 2px 4px rgba(20,184,166,0.05), 0 4px 12px rgba(20,184,166,0.15);
      }
      ...
      .gc-recipe-pro .gc-kpi-card:hover {
        ...
        box-shadow: 0 20px 32px -12px rgba(20,184,166,0.25);
      }
      ...
      .gc-recipe-pro .gc-group-row {
        background: linear-gradient(to right, rgba(20,184,166,0.03), rgba(245,158,11,0.03));
        font-weight: 700;
      }
      ...
      @keyframes group-flash {
        0%, 100% { background: linear-gradient(to right, rgba(20,184,166,0.03), rgba(245,158,11,0.03)); }
      ...
      .gc-recipe-pro .gc-type-btn.active {
        background: white;
        color: var(--primary-dark);
        box-shadow: 0 8px 20px -8px rgba(20,184,166,0.25);
        border: 1px solid rgba(20,184,166,0.2);
      }
      ...
      .gc-recipe-pro .gc-modern-select {
        ...
        font-size: 0.95rem;
        appearance: none;
        background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%2314b8a6' stroke-width='2'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e");
      ...
      .gc-meta-card:hover {
        ...
        box-shadow: 0 12px 24px -12px rgba(20,184,166,0.2);
      }
              ...
              <div style={{ marginTop: '24px' }}>
                <div className="gc-meta-card" style={{ padding: 0 }}>
                  <div 
                    ...
                    style={{ background: 'linear-gradient(to right, rgba(20,184,166,0.02), transparent)' }}
                  >
                    <div className="w-8 h-8 rounded-xl bg-secondary/10 flex items-center justify-center text-secondary">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M4 7h16M4 12h16M4 17h10" />
