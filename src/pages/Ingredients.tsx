...
export default function Ingredients() {
  ...
  // ✅ تعديل البحث ليشمل الكود أيضاً - هذا هو التغيير الوحيد في المنطق
  ...
  return (
    ...
    >
      ...
      {/* Filters - فقط هذا القسم تم تعديله */}
      <motion.div variants={itemVariants}>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="Search for a product" // 👈 هنا تظهر الكتابة التي تريدها
                  />
                  {search && (
                    <button 
                      type="button" 
                ...
                <p className="text-[10px] text-gray-500 dark:text-gray-400 mt-1">
                  Search by name, supplier, or code
                </p>
              </div>
      ...
      {/* Body - باقي المكونات لم يتم لمسها */}
      {!loading && !err && (
        <>
          {/* KPIs */}
