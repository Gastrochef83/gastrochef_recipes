...
function calcLineCost(l: ProLine, ing: IngredientPick | undefined, servingsPreview: number) {
  ...
  // Keep your existing behavior: convert between line.unit and ingredient.pack_unit
  ...
  // Yield: cost increases when yield < 100
                    ...
                    <tr key={l.id} className="border-t">
                      ...
                      <td className="py-3 pr-4">
                        ...
                        <div className="mt-1 text-xs text-neutral-500">
                          Pack unit: <span className="font-semibold">{ing?.pack_unit ?? '—'}</span> · Net unit cost:{' '}
                          <span className="font-semibold">{ing?.net_unit_cost == null ? '—' : fmtMoney(ing.net_unit_cost, currency)}</span>
                        </div>
                      </td>
